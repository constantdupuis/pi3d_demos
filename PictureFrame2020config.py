...
parse.add_argument(      "--show_text_sz",  default=20, type=int, help="text character size")
parse.add_argument(      "--show_text",     default="", help="show text, include combination of words: name, date, location")
...
parse.add_argument("-w", "--fade_time",     default=2.0, type=float, help="change time during which slides overlap - can be changed by MQTT")
